...
export function GridTemplate({ user, links, socials = [], theme }: GridTemplateProps) {
          ...
          {activeLinks.map((link) => {
            ...
            return (
              <a
                ...
                className="flex flex-col items-center justify-center p-4 aspect-square rounded-lg text-center transition-all"
                style={{
